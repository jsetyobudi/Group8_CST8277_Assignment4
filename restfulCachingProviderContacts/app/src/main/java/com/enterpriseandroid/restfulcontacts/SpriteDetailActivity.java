...
/*
 * SpriteDetailActivity class
 * Originally by Stanley Pieda, edited by Johan
    ...
    implements LoaderManager.LoaderCallbacks<Cursor>
{
   ...
   /*
    * onCreateLoader, used when new cursor is loaded
    */
    @Override
    ...
    /*
     * onLoadFinished method, populating the view
     */
    @Override
    ...
    /*
     * onLoaderReset method, empty
     */
    @Override
    public void onLoaderReset(Loader<Cursor> loader) { }
    /*
     * onCreate method, used on startup
     */
    @Override
    ...
    /*
     * onSaveInstanceState method, used when program is run again
     */
    @Override
    ...
    /*
     * delete method used for deleting
     */
    void delete() {
        if (null != contactUri) {
...
//        }
   ...
   /*
    * populateView method, populating the values
    */
    ...
    /*
     * goToSprites method, starting sprite activity
     */
    ...
    /*
     * getString method, getting string
     */
    private String getString(Cursor c, String col) {
        return c.getString(c.getColumnIndex(col));
    }
    /*
     * addString method, adding string
     */
